...
cd '/Users/ssilesky/Library/Application Support/Sublime Text 3/Packages/User/' && find "$(cd .; pwd)" -name ‘*.sublime-settings’ -print0 | xargs -0 gist -o -u 8d3b87b2aac5cc0b3805738540320dcd
